...
#'
#'
#' MIN (Nearest neighbor distance). Compiled and adapted from Allouche et al. (2008), this method calculates for each cel the Euclidian geographic distance to the nearest presence point.
#'
#'
